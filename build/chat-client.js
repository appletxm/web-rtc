	  ...
	  createClass(Connection, [{
	          ...
	          while (1) {
	            switch (_context.prev = _context.next) {
	              ...
	              case 12:
	                ...
	                console.info('**offer**', 'clientId: ', clientId, ' targetId: ', targetId, this['user']['offers']); // if (clientId !== targetId && this['user']['myPeerConnection'][targetId]) {
	    ...
	    value: function () {
	      var _handleVideoOfferMsg = asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee3(msg) {
	        var targetId, targetUsername, id, name, desc, _this$user2, socket, myUsername, clientId;
	          ...
	          while (1) {
	            switch (_context3.prev = _context3.next) {
	              case 0:
	                ...
	                // type: 'video-offer',
	                // sdp: this.connect.localDescription
	                targetId = msg.targetId, targetUsername = msg.targetUsername, id = msg.id, name = msg.name; // If we're not already connected, create an RTCPeerConnection
	              ...
	              case 22:
	                _this$user2 = this.user, socket = _this$user2.socket, myUsername = _this$user2.myUsername, clientId = _this$user2.clientId; // console.info('**answer**', this['user']['myPeerConnection'], 'msg id:', id, ' this.user.clientId:', this.user.clientId, ' msg targetId: ', targetId)
	    ...
	    value: function createConnect() {
	      ...
	      log(concat$2(_context14 = "======Create connection from ".concat(this.user.myUsername, " to ")).call(_context14, username));
	      this.createPeerConnection();
	      this.setTrackStream();
	    }
	  }]);
	...
	var Chat = /*#__PURE__*/function () {
	  ...
	  createClass(Chat, [{
	    ...
	    value: function addEvents() {
	      ...
	      var chatPanel = document.querySelector('.chat-box');
	      var btnDom = document.querySelector('#chat-send');
	      chatPanel.addEventListener('keyup', function (event) {
	    ...
	    value: function sendMessage() {
	      var inputDom = document.querySelector('#chat-text');
	      var value = inputDom.value;
	      value = value && trim$2(value).call(value);
